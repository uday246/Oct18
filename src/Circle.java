...
public class Circle {
	...
	/**
	 * A default Point for the center of a Circle - (0.0, 0.0) the coordinate
	 * system origin.
	 */
	 ...
	 *
	 * @param theRadius
	 *            the radius to assign to this Circle
	 * @param theCenter
	 *            the center point to assign to this Circle
	 * @param theColor
	 *            the color to assign to this Circle
	 * @throws IllegalArgumentException
	 *             if theRadius is less than or equal to zero
	 * @throws NullPointerException
	 *             if theCenter is null OR theColor is null
	 */
	public Circle(final double theRadius, final Point2D theCenter, final Color theColor) {
		...
		// One way to make a defensive copy is to use a copy constructor if the
		// class has one.
	 ...
	 *
	 * @param theRadius
	 *            the radius value to assign to this Circle
	 * @throws IllegalArgumentException
	 *             if theRadius is less than or equal to zero
	 */
	 ...
	 *
	 * @param thePoint
	 *            the center value to assign to this Circle
	 * @throws NullPointerException
	 *             if thePoint is null
	 */
	 ...
	 *
	 * @param theColor
	 *            the Color value to assign to this Circle
	 * @throws NullPointerException
	 *             if theColor is null
	 */
